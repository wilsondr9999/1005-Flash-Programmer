...
unsigned short numRetBytes;
unsigned char returnBytes;
    ...
    while (1) {
        ...
        switch (cmdBuf[0]) {
            case 0x80:
                ...
                numBytes=(cmdBuf[4]==0x00 ? 0x100 : cmdBuf[4]);
                ...
                if (successful) {
                    ackBuf[0]=0x81;
                    ackBuf[1]=(unsigned char)numRetBytes;
                    returnBytes=1;
                } else {
                    ackBuf[0]=0xC0;
                    returnBytes=0;
            ...
            case 0x81:
                ...
                ackBuf[0]=0x91;
                ackBuf[1]=(unsigned char)numBytes;
