...
unsigned char readFlash(unsigned long addr, unsigned char numBytes, unsigned char retBytes[], unsigned char *numRetBytes) {


    unsigned char done,length,bufPtr;
